...
public class ExcelUtilities {
	...
	public String getcellData(String sheetName,int rownum,int column_num ) throws IOException {
		fi=new FileInputStream(path);
		workbook=new XSSFWorkbook(fi);
		sheet=workbook.getSheet(sheetName);
		row=sheet.getRow(rownum);
	...
	public void setCelldata(String sheetName,int rownum,int column_num,String data) throws IOException {
